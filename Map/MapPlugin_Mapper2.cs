    ...
    public partial class MapPlugin
    {
        ...
        public partial class Constants //credits go to the authors of Terrafirma ..damn that xml took awhile to manually convert :(					
        {
            public static class Terrafirma_Color
            {
                ...
                public static Color HALLOWED_GRASS = ColorTranslator.FromHtml("#4EC1E3");
                ...
                public static Color MYTHRIL_BRICK = ColorTranslator.FromHtml("#91BF75");
                public static Color SILT = ColorTranslator.FromHtml("#595353");
                public static Color WOODEN_BEAM = ColorTranslator.FromHtml("#5C4436");
                ...
                public static Color CRYSTAL_SHARD = ColorTranslator.FromHtml("#004979");
                public static Color ACTIVE_STONE = ColorTranslator.FromHtml("#A5A5A5");
                public static Color INACTIVE_STONE = ColorTranslator.FromHtml("#1A1A1A");
                public static Color LEVER = ColorTranslator.FromHtml("#C90303");
                public static Color ADAMANTITE_FORGE = ColorTranslator.FromHtml("#891012");
                public static Color MYTHRIL_ANVIL = ColorTranslator.FromHtml("#96AE87");
                ...
                public static Color DART_TRAP = ColorTranslator.FromHtml("#8C8C8C");
                public static Color BOULDER = ColorTranslator.FromHtml("#636363");
                public static Color MUSIC_BOX = ColorTranslator.FromHtml("#996343");
                public static Color DEMONITE_BRICK = ColorTranslator.FromHtml("#7875B3");
                public static Color EXPLOSIVES = ColorTranslator.FromHtml("#AD2323");
                public static Color INLET_PUMP = ColorTranslator.FromHtml("#C90303");
                public static Color OUTLET_PUMP = ColorTranslator.FromHtml("#C90303");
                public static Color TIMER = ColorTranslator.FromHtml("#C90303");
                // 1.1.1 TILES
                public static Color CANDY_CANE_BLOCK = ColorTranslator.FromHtml("#C01E1E");
                public static Color GREEN_CANDY_CANE_BLOCK = ColorTranslator.FromHtml("#2BC01E");
                public static Color SNOW_BLOCK = ColorTranslator.FromHtml("#C7DCDF");
                public static Color SNOW_BRICK = ColorTranslator.FromHtml("#D3ECF1");
                ...
                public static Color PEARLSTONE_BRICK_WALL = ColorTranslator.FromHtml("#716363");
                public static Color IRIDESCENT_BRICK_WALL = ColorTranslator.FromHtml("#4E4042");
                public static Color MUDSTONE_BRICK_WALL = ColorTranslator.FromHtml("#403033");
                public static Color COBALT_BRICK_WALL = ColorTranslator.FromHtml("#0B233E");
                public static Color MYTHRIL_BRICK_WALL = ColorTranslator.FromHtml("#3C5B3A");
                public static Color PLANKED_WALL = ColorTranslator.FromHtml("#3A291D");
                public static Color PEARLSTONE_WALL = ColorTranslator.FromHtml("#515465");
                // 1.1.1 WALLS
                public static Color CANDY_CANE_WALL = ColorTranslator.FromHtml("#581717");
                public static Color GREEN_CANDY_CANE_WALL = ColorTranslator.FromHtml("#2C6A26");
                public static Color SNOW_BRICK_WALL = ColorTranslator.FromHtml("#6B7577");
